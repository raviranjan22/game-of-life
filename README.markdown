...
## Building the projectuppu uppu1---Ravi

The project is a simple multi-module Maven project. To build the whole project, just run `mvn install` from the root directory.

## Running the game Hello from uppu bbbbb yyyy-- added comments on the read me
...
## Running the acceptance This is for ofss
...
## The book for upasana , and DevOps batch----- This is from DevOps Seminar
